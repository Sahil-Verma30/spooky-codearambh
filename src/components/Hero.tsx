  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      icons.forEach((icon, index) => {
        ...
        iconElement.style.transform = `translate(${x * speed}px, ${y * speed}px)`;
      });
    };
    ...
    >
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 animate-bounce opacity-0 fade-in-up delay-500">
          <a href="#about" className="text-halloween-ghostWhite/60 hover:text-halloween-ghostWhite transition-colors">
